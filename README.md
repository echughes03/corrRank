...
## cplot
The _cplot_ function creates a set of clean, simple scatterplots of given predictor-outcome relationships. The correlation value and fitted simple linear regression line can easily be added and removed.
