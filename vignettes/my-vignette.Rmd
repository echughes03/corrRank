...
The function `cplot()` can also generate scatterplots that exclude the line of best fit and the correlation output by specifying `line = F` and `r = F` respectively. Futhermore, for naming conventions, the title and title axes can be modified according to `ggplot2` labelling conventions.
